...
public class TimeCtl implements Runnable {
    ...
    private static TimeCtl instance = null;

    // register observers here
    public static void init() {
        instance = new TimeCtl();
        // run on a new thread
        try {
    ...
    public static TimeCtl getInstance() {
        if (instance == null) {
    ...
    public int getCurrentDate() {
        return DateTime.getCurrentDate().getDate();
    }
